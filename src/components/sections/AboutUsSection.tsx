    ...
    return (
        <section className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-6">
                ...
                {/* Main Description */}
                <div className="mb-20">
                    <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12 border-t-4 border-purple-600">
                                    ...
                                    {section.personImage ? (
                                        <div className="relative">
                                            <div className="w-48 h-48 mx-auto relative rounded-full overflow-hidden shadow-2xl border-4 border-white">
                                                <Image
                                                    src={urlFor(section.personImage).width(300).height(300).url()}
                                        ...
                                        <div className="w-48 h-48 mx-auto bg-gradient-to-br from-purple-600 to-pink-500 rounded-full flex items-center justify-center shadow-2xl">
                        ...
                        {section.personName.split(' ').map(n => n[0]).join('')}
                                ...
                                <div className="lg:col-span-3">
                                    <div className="bg-white rounded-xl p-8 shadow-lg relative">
                                        {/* Quote marks */}
                                        <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-500 rounded-full flex items-center justify-center">
                                            <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                <path fillRule="evenodd" d="M6 3a1 1 0 011-1h.01a1 1 0 010 2H7a1 1 0 01-1-1zm2 3a1 1 0 00-2 0v1a2 2 0 00-2 2v3a2 2 0 002 2h1a2 2 0 002-2V9a2 2 0 00-2-2V6z" clipRule="evenodd" />
                                            </svg>
                                        </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    {/* Mission Card */}
                    <div className="group">
                        <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group-hover:-translate-y-2 border-l-4 border-purple-600">
                    ...
                    {/* Vision Card */}
                    <div className="group">
                        <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group-hover:-translate-y-2 border-l-4 border-pink-500">
                ...
                <div className="mt-16 text-center">
                    <div className="bg-gradient-to-r from-purple-600 to-pink-500 rounded-2xl p-8 text-white">
                        <h3 className="text-3xl font-bold mb-4">Excellence in Education Since 1927</h3>
                        <p className="text-xl opacity-90">Building tomorrow's leaders through innovative learning experiences</p>
                    </div>
                </div>
