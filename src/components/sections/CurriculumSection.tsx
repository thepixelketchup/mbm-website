...
export default function CurriculumSection({
  ...
  const getFileTypeColor = (category?: string) => {
    ...
    if (type?.includes("doc")) return "from-blue-500 to-blue-600";
    if (type?.includes("syllabus")) return "from-green-500 to-green-600";
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-gradient-to-br from-muted/20 to-muted/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-primary to-accent text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full mb-4 sm:mb-6 shadow-lg">
          ...
          {documentsToShow.length > 0 ? (
              ...
              {documentsToShow.map((doc) => {
                ...
                return (
                  ...
                  >
                    {/* Document Header */}
                    <div
                      className={`bg-gradient-to-r ${getFileTypeColor(doc.category)} p-4 sm:p-6 text-white relative overflow-hidden`}
                    >
                      ...
                      <div className="mt-auto">
                        {documentUrl ? (
                          <a
                            ...
                            className="w-full inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-primary to-accent text-white rounded-xl font-semibold text-sm sm:text-base hover:from-accent hover:to-secondary transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
                          >
            ...
            <div className="max-w-md mx-auto text-center">
              <div className="bg-white rounded-2xl sm:rounded-3xl p-8 sm:p-12 shadow-lg border border-muted">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-primary/20 to-accent/20 rounded-full flex items-center justify-center mx-auto mb-6 sm:mb-8">
        ...
        section.gradeWiseCurriculum.length > 0 && (
          <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              {/* Section Header */}
              <div className="text-center mb-8 sm:mb-12 lg:mb-16">
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-accent to-secondary text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full mb-4 sm:mb-6 shadow-lg">
              ...
              <div className="space-y-6 sm:space-y-8">
                {section.gradeWiseCurriculum.map((grade, index) => (
                  <div
                    key={grade.grade}
                    className="bg-gradient-to-br from-muted/30 to-muted/50 rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-muted group"
                  >
                    {/* Grade Header */}
                    <div className="bg-gradient-to-r from-primary to-accent p-4 sm:p-6 lg:p-8 text-white relative overflow-hidden">
                        ...
                        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-md hover:shadow-lg transition-all duration-300 border border-muted group/item hover:-translate-y-1 mb-6">
                          <div className="flex items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                              <div className="w-10 h-10 bg-gradient-to-r from-accent to-secondary rounded-lg flex items-center justify-center group-hover/item:scale-110 transition-transform duration-300">
