  ...
  return (
    <footer className="bg-muted text-zinc-200 font-sans">
      ...
      <div className="mx-auto max-w-7xl grid gap-10 px-6 py-14 lg:grid-cols-4">
        <div>
          <h3 className="mb-6 text-primary border-b border-zinc-700 pb-2 text-lg font-bold uppercase">
            Our Pages
          </h3>
        ...
        <div className="md:col-span-3">
          ...
          <div className="grid gap-y-8 lg:gap-x-2 text-xs sm:grid-cols-3">
            <div>
              <h4 className="text-xl font-normal mb-2 text-foreground">
                Head Office
              </h4>
            ...
            <div>
              <h4 className="mb-2 text-xl font-normal text-foreground">
                Branches
              </h4>
