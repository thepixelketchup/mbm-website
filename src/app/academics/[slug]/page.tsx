...
export default async function AcademicsPage({ params }: AcademicsPageProps) {
  try {
    ...
    const allDocuments: CurriculumDocument[] = Array.isArray(allDocumentsRaw)
      ? allDocumentsRaw
      : [];
          ...
          try {
            switch (section._type) {
              ...
              case "facilitiesSection":
                return (
                  <FacilitiesSection key={section._key} section={section} />
                );
            ...
            console.error(
              `Error rendering section ${section._type}:`,
              sectionError,
            );
              ...
              <section key={section._key} className="py-16 bg-red-50">
                <div className="max-w-4xl mx-auto px-6 text-center">
                  ...
                  <p className="text-red-600">
                    There was an error loading this academic section. Please try
                    refreshing the page.
                  </p>
                </div>
              </section>
      ...
      <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-pink-50">
        <div className="text-center px-6">
          ...
          <p className="text-xl text-red-600 mb-8">
            We encountered an error while loading this academic page. Please try
            again later.
          </p>
          <div className="space-y-4">
            <Link
